  ...
  return (
    <div className="main-page_wrapper">
      ...
      <div className="main-page-text_wrapper">
        <p>
          Welcome to advisor-link a hub for financial advisers and their clients
          to communicate, plan investment strategies and buy/sell investments.
        </p>
        <p>
          If you are an adviser then log in or sign up with your details, if you
          are a client then to sign up or log in you will need to have an
